...
>  4. **Review Our Contribution Guidelines**: Before you start, review our contribution guidelines. These guidelines outline the rules and best practices for contributing to GherKing. You can find it [here](https://github.com/gherking/.github/blob/main/CONTRIBUTING.md).
> 
